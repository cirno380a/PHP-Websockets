...
abstract class WebSocketServer {
  ...
  public function stdout($message) {
    if ($this->interactive) {
      file_put_contents($this->logFile, '[' . date('Y-m-d H:i:s') . '] [OUT] ' . $message . PHP_EOL, FILE_APPEND);
    }
  }

  public function stderr($message) {
    if ($this->interactive) {
      file_put_contents($this->logFile, '[' . date('Y-m-d H:i:s') . '] [ERR] ' . $message . PHP_EOL, FILE_APPEND);
    }
  }
